<button type="button" class="btn btn-warning" data-bs-toggle="modal" data-bs-target="#editPointsModalForID:<?php echo $brother['BrotherID'];?>" id="editButtonForID<?php echo $brother['BrotherID'];?>">Edit</button>

<div class="modal fade" id="editPointsModalForID:<?php echo $brother['BrotherID'];?>" tabindex="-1" aria-labelledby="addBrotherModalLabel" aria-hidden="true">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form method="post" action="">
          ...
          <div class="mb-3">
            <label for="BPForID:<?php echo $brother['BrotherID'];?>" class="form-label">Service Points</label>
