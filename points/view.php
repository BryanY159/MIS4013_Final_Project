<div class="row" style="width: 50%;"> <!-- Match the table width -->
  ...
  <div class="col">
    ...
    <?php }  else { ?>
      <button class="btn btn-info" style="float: right;" onclick="startIntro()">Need help?</button>
    <?php } ?>
  </div>
</div>
  ...
  <table class="table">
    <thead>
      <tr>
        ...
        <th style="width: 135px; text-align: center;">Brotherhood Points</th>
            ...
            <td style="text-align: center;">
              <?php if($brother['ServicePoints'] >= 5 && $brother['BrotherhoodPoints'] >= 3) { ?> 
                <form method="post" action="points.php">
                  ...
                  <button type="submit" class="btn btn-success" data-step="<?php echo $filter_data_step;?>" style="width: 45px;">
              ...
              <?php }
                ...
                <form method="post" action="points.php">
                  ...
                  <button type="submit" class="btn btn-danger" data-step="<?php echo $filter_data_step;?>" style="width: 45px;">
            ...
            <td style="text-align: center;">
              <?php
                if($brother['ServicePoints'] >= 5) { ?>
                  <button class="btn btn-success" data-step="<?php echo $points_data_step;?>" style="width: 45px;"><?php echo $brother['ServicePoints'];?></button>
                <?php }
                else { ?>
                  <button class="btn btn-secondary" data-step="<?php echo $points_data_step;?>" style="width: 45px;"><?php echo $brother['ServicePoints'];?></button>
                <?php }
              ?>
            </td>
            <td style="text-align: center;">
